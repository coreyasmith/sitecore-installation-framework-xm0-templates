# 🏗️ XM Single (XM0) templates for Sitecore 10.4 Update-1

XM Single (XM0) templates for [Sitecore 10.4 Update-1][1]. These templates install a full headless stack with the latest cumulative hotfixes[^1].

## ⭐ Packages Installed

| Package | URL |
| ------- | --- |
| Sitecore 10.4 Update-1 | <https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/104/Sitecore_Experience_Platform_104_Update1> |
...
2. Place the following packages into the [`./packages`](./packages/) folder:
   - `license.xml`
   - `Sitecore 10.4.1 rev. 012149 (XM) (OnPrem)_cm.scwdp.zip` (extract from _Packages for XM Scaled_ for _On Premises deployment_)
   ...
   - `Sitecore 10.4.2 rev. 014339 PRE (XM) (OnPrem)_cm.delta.scwdp.zip`[^1] (extract from `Sitecore 10.4.2 rev. 014339 (DELTA WDP XM1 packages).zip`)
   - `Sitecore.IdentityServer 8.0 rev. 37 (OnPrem)_identityserver.delta.scwdp.zip`[^1] (extract from `Sitecore 10.4.2 rev. 014339 (DELTA WDP XM1 packages).zip`)
...
[1]: https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/104/Sitecore_Experience_Platform_104_Update1
