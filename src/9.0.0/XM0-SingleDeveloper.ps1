...
$SitecorePackage = (Get-ChildItem "$SCInstallRoot\packages\Sitecore 9.0.0 rev. * (OnPrem)_cm.scwdp.zip").FullName
# The path to the Sitecore JavaScript Services Server Package to Deploy.
$JavaScriptServicesServerPackage = (Get-ChildItem "$SCInstallRoot\packages\Sitecore JavaScript Services Tech Preview Server*.zip").FullName
# The path to the Sitecore JavaScript Services Infrastructure Package to Deploy.
$JavaScriptServicesInfrastructurePackage = (Get-ChildItem "$SCInstallRoot\packages\Sitecore JavaScript Services Tech Preview Infrastructure*.zip").FullName
...
# The path to the Sitecore Azure Toolkit tools folder, used to convert the JavaScript Services packages.
$AzureToolkitToolsPath = "$SCInstallRoot\lib\sat\tools"
# The path to the Security Bulletin SC2023-003-587441 Package to Deploy.
$SC2023_003Package = (Get-ChildItem "$SCInstallRoot\packages\SC Hotfix 589744-1*.zip").FullName
...
$javaScriptServicesParams = @{
    ...
    ServerPackage = $JavaScriptServicesServerPackage
    InfrastructurePackage = $JavaScriptServicesInfrastructurePackage
