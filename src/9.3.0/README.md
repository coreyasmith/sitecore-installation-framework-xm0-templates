# 🏗️ XM Single (XM0) templates for Sitecore 9.3 Initial Release

XM Single (XM0) templates for [Sitecore 9.3 Initial Release][1]. These templates install a full headless stack with the latest cumulative hotfixes[^1] and security bulletins.

## ⭐ Packages Installed

| Package | URL |
| ------- | --- |
| Sitecore 9.3 Initial Release | <https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/93/Sitecore_Experience_Platform_93_Initial_Release> |
...
| Sitecore Experience Accelerator 9.3.0 | <https://developers.sitecore.com/downloads/Sitecore_Experience_Accelerator/9x/Sitecore_Experience_Accelerator_930> |
| Sitecore JavaScript Services 13.0.0 | <https://developers.sitecore.com/downloads/Sitecore_JavaScript_Services/130/Sitecore_JavaScript_Services_1300> |
...
| Cumulative hotfix for Sitecore 9.3 (XM, XP)[^1] | <https://support.sitecore.com/kb?id=kb_article_view&sysparm_article=KB1001332> |
| Cumulative hotfix for SXA 9.3.0[^1] | <https://support.sitecore.com/kb?id=kb_article_view&sysparm_article=KB1001754> |
...
2. Place the following packages into the [`./packages`](./packages/) folder:
   - `license.xml`
   - `Sitecore 9.3.0 rev. 003498 (XM) (OnPrem)_cm.scwdp.zip` (extract from _Packages for XM Scaled_ for _On Premises deployment_)
   ...
   - `SC Hotfix PDXP-7469-1.zip` (Cumulative hotfix for Sitecore 9.3)
   - `SC Hotfix SXA-8487-1 9.3.0.2589.zip` (Cumulative hotfix for SXA 9.3.0)
...
[1]: https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/93/Sitecore_Experience_Platform_93_Initial_Release
