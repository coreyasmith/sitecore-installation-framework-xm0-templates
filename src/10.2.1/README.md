# 🏗️ XM Single (XM0) templates for Sitecore 10.2 Update-1

XM Single (XM0) templates for [Sitecore 10.2 Update-1][1]. These templates install a full headless stack with the latest cumulative hotfixes[^1] and security bulletins.

## ⭐ Packages Installed

| Package | URL |
| ------- | --- |
| Sitecore 10.2 Update-1 | <https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/102/Sitecore_Experience_Platform_102_Update1> |
...
2. Place the following packages into the [`./packages`](./packages/) folder:
   - `license.xml`
   - `Sitecore 10.2.1 rev. 009559 (XM) (OnPrem)_cm.scwdp.zip` (extract from _Packages for XM Scaled_ for _On Premises deployment_)
   ...
   - `Sitecore 10.2.3 rev. 013888 PRE (XM) (OnPrem)_cm.cumulative.delta.scwdp.zip`[^1] (extract from `Sitecore 10.2.3 rev. 013888 (CUMULATIVE DELTA WDP XM1 packages).zip`)
   - `Sitecore.IdentityServer 8.0 rev. 37 (OnPrem)_identityserver.cumulative.delta.scwdp.zip`[^1] (extract from `Sitecore 10.2.3 rev. 013888 (CUMULATIVE DELTA WDP XM1 packages).zip`)
...
> [!WARNING]
> [Cumulative hotfix for SXA 10.2.0][3] installs the [Sitecore PowerShell Extensions (SPE) 6.3][4] IAR files, so [SPE 8][5] is reinstalled after [Cumulative hotfix for SXA 10.2.0][3] in [Sitecore 10.2 Update-1][1]. If you install [SPE 6.3][4], you can remove the reinstall of SPE after [Cumulative hotfix for SXA 10.2.0][3].
...
[1]: https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/102/Sitecore_Experience_Platform_102_Update1
