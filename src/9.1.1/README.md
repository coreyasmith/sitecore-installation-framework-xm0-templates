# 🏗️ XM Single (XM0) templates for Sitecore 9.1 Update-1

XM Single (XM0) templates for [Sitecore 9.1 Update-1][1]. These templates install a full headless stack with the latest cumulative hotfixes[^1] and security bulletins.

## ⭐ Packages Installed

| Package | URL |
| ------- | --- |
| Sitecore 9.1 Update-1 | <https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/91/Sitecore_Experience_Platform_91_Update1> |
...
| Sitecore JavaScript Services 11.1.0 | <https://developers.sitecore.com/downloads/Sitecore_JavaScript_Services/110/Sitecore_JavaScript_Services_1110> |
...
| Cumulative hotfix for Sitecore 9.1.1 (XM)[^1] | <https://support.sitecore.com/kb?id=kb_article_view&sysparm_article=KB1001330> |
| Cumulative hotfix for SXA 1.9.0[^1] | <https://support.sitecore.com/kb?id=kb_article_view&sysparm_article=KB1001752> |
...
2. Place the following packages into the [`./packages`](./packages/) folder:
   - `license.xml`
   - `Sitecore 9.1.1 rev. 002459 (XM) (OnPrem)_cm.scwdp.zip` (extract from _Packages for XM Scaled_ for _On Premises deployment_)
   - `Sitecore Experience Accelerator XM 1.9.0 rev. 190528 for 9.1.scwdp.zip`
   - `Sitecore JavaScript Services Server for Sitecore 9.1.1 XM 11.1.0 rev. 190508.scwdp.zip`
   ...
   - `SC Hotfix 607669-1.zip` (Cumulative hotfix for Sitecore 9.1.1)
   - `SC Hotfix 517845-1 SXA 1.9.0 rev. 190528.zip` (Cumulative hotfix for SXA 1.9.0)
...
[1]: https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/91/Sitecore_Experience_Platform_91_Update1
