...
$SitecorePackage = (Get-ChildItem "$SCInstallRoot\packages\Sitecore 9.1.1 rev. * (XM) (OnPrem)_cm.scwdp.zip").FullName
...
$SitecoreCumulativeHotfixPackage = (Get-ChildItem "$SCInstallRoot\packages\SC Hotfix 607669-*.zip").FullName
# The path to the SXA cumulative hotfix Package to Deploy.
$SXACumulativeHotfixPackage = (Get-ChildItem "$SCInstallRoot\packages\SC Hotfix 517845-* SXA *.zip").FullName
