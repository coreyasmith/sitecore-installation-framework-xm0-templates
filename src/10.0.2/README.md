# 🏗️ XM Single (XM0) templates for Sitecore 10.0 Update-2

XM Single (XM0) templates for [Sitecore 10.0 Update-2][1]. These templates install a full headless stack with the latest cumulative hotfixes[^1] and security bulletins.

## ⭐ Packages Installed

| Package | URL |
| ------- | --- |
| Sitecore 10.0 Update-2 | <https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/100/Sitecore_Experience_Platform_100_Update2> |
...
2. Place the following packages into the [`./packages`](./packages/) folder:
   - `license.xml`
   - `Sitecore 10.0.2 rev. 006052 (XM) (OnPrem)_cm.scwdp.zip` (extract from _Packages for XM Scaled_ for _On Premises deployment_)
...
[1]: https://developers.sitecore.com/downloads/Sitecore_Experience_Platform/100/Sitecore_Experience_Platform_100_Update2
