...
$SitecorePackage = (Get-ChildItem "$SCInstallRoot\packages\Sitecore 9.2.0 rev. * (XM) (OnPrem)_cm.scwdp.zip").FullName
...
$SitecoreCumulativeHotfixPackage = (Get-ChildItem "$SCInstallRoot\packages\SC Hotfix 584731-*.zip").FullName
